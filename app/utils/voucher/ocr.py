...
- 令和(R): 西暦 = 2018 + 和暦年（R1=2019, R8=2026）
- 平成(H): 西暦 = 1988 + 和暦年（H1=1989, H31=2019）
- 昭和(S): 西暦 = 1925 + 和暦年（S1=1926, S64=1989）
- 元号なし2桁年の場合: 現在年(2026)以内になる元号で解釈（例: "08-03-16" → 令和8年3月16日 → "2026-03-16"）
...
【日付。通帳の日付は和暦。2桁年は和暦年として西暦変換（例: "08-03-16" → 令和8年 → "2026-03-16"）
...
3. 「*」は金額の修飾記号。「*98,800」→98800、「*3,413,114」→3413114（数値のみ、桁数を変えない）
4. 残高は差引残高列の値のみ。直後の備考数字（980・960・186・217など）は残高に含めない。
5. 日付は和暦。2桁年は和暦年として西暦変換（例: 〈08-03-16」 → 令和8年3月16日 → 」2026-03-16」）
